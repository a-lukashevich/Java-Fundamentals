...
public class CaclulateHelper {
    ...
    public void process(String statement) throws InvalidStatementExeption {
        // add 1.0 2.0
        ...
        if(command == null)
            throw new InvalidStatementExeption("Invalid command", statement);
